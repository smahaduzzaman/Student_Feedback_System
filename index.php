...
<body>
    ...
    <!-- Navigation -->
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background:#1B1A47">
        <div class="container">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="index.php?info=faculty_login">Department</a></li>
    ...
    ?>
        ...
        <header id="myCarousel" class="carousel slide">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    ...
                    <div class="fill" style="background-image:url('images/fdbc1.jpeg'); width: 100%; height: 400px;"></div>
                ...
                <div class="item">
                    <div class="fill" style="background-image:url('images/fdbc2.jpg'); width: 100%; height: 400px;"></div>
                    <div class="carousel-caption">
                ...
                <div class="item">
                    <div class="fill" style="background-image:url('images/fdbc3.png'); width: 100%; height: 400px;"></div>
                    <div class="carousel-caption">
        ...
        <div class="container">
            ...
            <div class="navbar-fixed-bottom nav navbar-inverse text-center" style="padding:15px;height:40px; background:#1B1A47">
                <span style="color:#FFFFFF">Developed By ... <a href="http://www.smahaduzzaman.com">S M Ahaduzzaman</a> </span>
            </div>
            <!-- jQuery -->
